...
namespace BrokerageOnline.Workflow {
    ...
    public partial class Workflow_RackRate : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Workflow_RackRate).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Workflow_RackRate));
        ...
        private string FindResource() {
            string[] resources = typeof(Workflow_RackRate).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Workflow_RackRate.g.xaml") || resource.Equals("Workflow_RackRate.g.xaml"))) {
                    return resource;
                }
            }
