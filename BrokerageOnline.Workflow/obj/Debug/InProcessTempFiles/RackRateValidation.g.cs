...
namespace BrokerageOnline.Workflow {
    ...
    public partial class RackRateValidation : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<bool> _Allow;
        ...
        private System.Activities.OutArgument<string> _Error;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<bool> Allow {
            get {
                return this._Allow;
            }
            set {
        ...
        public System.Activities.OutArgument<string> Error {
            get {
                return this._Error;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RackRateValidation).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RackRateValidation));
        ...
        private string FindResource() {
            string[] resources = typeof(RackRateValidation).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RackRateValidation.g.xaml") || resource.Equals("RackRateValidation.g.xaml"))) {
                    return resource;
                }
            }
