...
namespace BrokerageOnline.Workflow {
    ...
    public partial class Rules_CreateRackRate : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Rules_CreateRackRate).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Rules_CreateRackRate));
        ...
        private string FindResource() {
            string[] resources = typeof(Rules_CreateRackRate).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Rules_CreateRackRate.g.xaml") || resource.Equals("Rules_CreateRackRate.g.xaml"))) {
                    return resource;
                }
            }
