...
!function ($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                button: '<button  type="button" class="multiselect dropdown-toggle c-round" data-toggle="dropdown"></button>',
         ...
         */
        rebuildscheme: function () {
            this.$ul.html('');

            // Important to distinguish between radios and checkboxes.
            this.options.multiple = this.$select.attr('multiple') === "multiple";
            this.options.nonSelectedText = "Select Scheme";
            this.options.includeSelectAllOption = true;
            this.options.true = true;
            this.options.enableCaseInsensitiveFiltering = true;
