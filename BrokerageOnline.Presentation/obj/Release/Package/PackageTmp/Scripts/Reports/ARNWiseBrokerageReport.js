var arnwisesummary = {
    ...
    PrintDetails: function () {
        if ($('#dt_from').val() != "" && $('#dt_to').val() != "") {
            var param = "";
            var FileURL = Utility.ARNWiseReport;
...
$(function () {
    arnwisesummary.GetDistributorCategory('');
    arnwisesummary.GetMemoTypes(0);
    arnwisesummary.GetARN();
    arnwisesummary.GetChannel('');
    arnwisesummary.LoadZone();
    arnwisesummary.GetScheme('');
    arnwisesummary.GetSchemeCategory('');
    arnwisesummary.GetMemoStatus();
