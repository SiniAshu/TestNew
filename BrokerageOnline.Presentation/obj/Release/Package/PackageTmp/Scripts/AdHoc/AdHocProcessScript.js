var AdHocProcess = {
    ...
    ReturnViewRemarksHyperLink: function (cellValue, options, rowdata, action) {
        return '<a href="#" style="text-decoration:none; color:#006bb4;border-bottom:1px solid #006bb4;" onclick=\"AdHocProcess.AdHocPaymentDetail(' + rowdata.PaymentListId + ');\">View Remarks</a>';
    },
...
$(function () {
    ...
    jQuery("#grid_sub_processing").jqGrid({
        ...
        width: null,
        shrinkToFit: false,
        colNames: ['<input type="checkbox" id="sub_checkAll" >Select</input>', 'S.No.', 'ARN No.', 'ARN Name', 'Scheme', 'Channel', 'Branch', 'Period From', 'Period To', 'Amount Basis', 'Rate (bps)', 'AUM (Lakhs) / Gross Sales (Actual)', 'Payment Amount', 'Actual Amount Payable (Round Off)', 'Remarks', '', 'MemoTypeID', 'PaymentMemoID', 'PaymentListID', 'IsRequired', 'RaisedByEmail'],
        colModel: [
