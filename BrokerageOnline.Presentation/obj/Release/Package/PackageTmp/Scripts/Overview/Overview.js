var Overview = {
    ...
    LoadData: function () {
        ...
        jQuery("#grid_search_result").jqGrid({
            ...
            sortable: true,
            rowNum: -1,
            colNames: ['Select', 'Memo Number', 'Memo Type', 'Memo Type ID', 'Category', 'ARN No', 'ARN Name', 'From Date', 'To Date', 'Status', 'Status', 'Raised By', 'Raised On', 'Time', 'Ageing', 'Action By'],
            colModel: [
                    { name: 'select', formatter: Overview.ReturnRadioBox, width: '60px;', hidden: true },
                    { name: 'PaymentMemoId', index: 'PaymentMemoId', align: 'right', formatter: Overview.ReturnSearchHyperLink },
                    { name: 'MemoTypeName', index: 'MemoTypeName' },
                    ...
                    { name: 'DateTo', width: 90, index: 'DateTo', align: 'center' },
                     ...
                     { name: 'MemoStatusDisplay', index: 'MemoStatusDisplay', align: 'center', width: 90 },
