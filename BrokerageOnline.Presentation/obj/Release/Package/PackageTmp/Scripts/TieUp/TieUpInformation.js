var TieUp = {
    ...
    ViewInitiateTieUp: function () {
        ...
        input = $('<button class="btn btn-warning sq-btn mr-right-01" onclick="TieUp.clearFields(); "><img src="../img/repeat-btn.png"></button>' +
            '<button class="btn btn-primary sq-btn mr-right-01" id="btn_search" onclick=\"TieUp.SearchTieUp();\">Search</button> <button class="btn mr-right-01 btn-success sq-btn" onclick=\"TieUp.InitiateSubmit();\">Submit</button>');
        $("#div_btn").append(input);
    ...
    addRow: function () {
        var tableRow = '<tr class="trail_row">' +
                                       ...
                                       ' <td><input type="text" class="input-text-bx-style c-round numberonly" style="margin-right:4px;" maxlength="2" name="trail_period_to" disabled /></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_base" disabled onkeyup="TieUp.Calculatetrail(this);"/></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_additional" disabled onkeyup="TieUp.Calculatetrail(this);"/></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round negativenumber" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_less_tieup" onkeyup="TieUp.Calculatetrail(this);"/></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_total" disabled/></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_greater" disabled/><input type="hidden" name="trail_lumpsum_greater_hidden" /></td>' +
                                         '<td><input type="text" class="input-text-bx-style c-round negativenumber" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_greater_tieup" onkeyup="TieUp.Calculatetrail(this);"/></td>' +
                                          '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_lumpsum_greater_total" /></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_sip_less" /></td>' +
                                        '<td><input type="text" class="input-text-bx-style c-round numberonly converttoint" style="margin-right:4px;" maxlength="4" name="trail_sip_greater" /></td>' +
...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        colModel: [
                { name: 'selectradio', formatter: TieUp.ReturnRadioBox, width: '60px;' },
                {
                    name: 'selectcheck', width: '80px;', align: 'center', editable: true, sortable: false, hidden: true, formatter: 'checkbox', editoptions: { value: "True:False" }, edittype: "checkbox", formatoptions: { disabled: false },
                ...
                { name: 'MemoId', index: 'MemoId', align: 'right', formatter: TieUp.ReturnSearchHyperLink },
                { name: 'MemoNumber', index: 'MemoNumber', align: 'left', hidden: true, formatter: TieUp.ReturnMemonumberSearchHyperLink },
               ...
               { name: 'MemoStatus', index: 'MemoStatus', align: 'center', width: 90, hidden: true },
                 { name: 'MemoStatusDisplay', index: 'MemoStatusDisplay', align: 'center', width: 98 },
