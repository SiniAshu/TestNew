...
$(function () {
    ...
    Utility.ServiceCall("POST", 'BaseRackRateService.svc/GetScheme', JSON.stringify({ SearchText: '', MemoTypeId: "0" }), "json", false, false, function (result) {
        ...
        //    if (SchemeSequence.TempSchemeCategory == )

        //    if ($.inArray(arrItems[i].SchemeCategoryName, SchemeSequence.TempSchemeCategory) < 0) {
        //        PaymentMemoparam["SchemeCategoryId"] = arrItems[i].SchemeCategoryId;
        //        PaymentMemoparam["SchemeCategoryName"] = arrItems[i].SchemeCategoryName;
        //        SelectedSchemeCategory.push(PaymentMemoparam);
        //    }
        //}
