...
$(function () {
    $("#grid_role").jqGrid({
        ...
        colModel: [
                    ...
                    { name: 'ExitLoadId', index: 'ExitLoadId', width: 100, align: 'center', sortable: false },
                    ...
                    { name: 'SchemeCategory', index: 'SchemeCategory', width: 150, sortable: false },
                    { name: 'Scheme', index: 'Scheme', width: 300, sortable: false },
                    { name: 'ExitLoad', index: 'ExitLoad', width: 470, sortable: false },
                    { name: 'EffectiveDate', index: 'EffectiveDate', width: 130, sortable: false },
