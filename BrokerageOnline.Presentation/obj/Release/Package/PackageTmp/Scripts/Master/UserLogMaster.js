...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        colModel: [
                { name: 'EmployeeID', index: 'EmployeeID', width: 90, align: 'center', sortable: false },
                ...
                { name: 'SubRegionName', width: 120, index: 'SubRegionName', sortable: false },
                { name: 'LoggedInTime_str', width: 210, index: 'LoggedInTime_str', align: 'center', sortable: false },
                { name: 'LoggedOutTime_str', width: 210, index: 'LoggedOutTime_str', align: 'center', sortable: false },
                { name: 'LastAccessedTime_str', width: 210, index: 'LastAccessedTime_str', align: 'center', sortable: false },
                { name: 'LoggedOutUser', index: 'LoggedOutUser', width: 150, sortable: false },
                { name: 'StatusName', index: 'StatusName', width: 200, sortable: false }
        ],
