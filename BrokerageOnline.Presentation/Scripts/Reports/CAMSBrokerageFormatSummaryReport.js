var CAMSBrokerageFormatSummary = {
    ...
    PrintDetails: function () {
        if ($('#dt_from').val() != "" && $('#dt_to').val() != "") {
            var param = "";
            var FileURL = Utility.CAMSBrokerageFormatSummaryReportPSI;
            var FileURLTrail = Utility.CAMSBrokerageFormatSummaryReportTrail;
            ...
            FileURLTrail = FileURLTrail.replace("###INPUT###", param);
            Utility.openWin(FileURL);
            Utility.openWin(FileURLTrail);
        }
        else {
...
$(function () {
    CAMSBrokerageFormatSummary.GetDistributorCategory('');
    //CAMSBrokerageFormatSummary.GetMemoTypes(0);
    CAMSBrokerageFormatSummary.GetARN();
    CAMSBrokerageFormatSummary.GetChannel('');
    CAMSBrokerageFormatSummary.LoadZone();
    CAMSBrokerageFormatSummary.GetScheme('');
    CAMSBrokerageFormatSummary.GetSchemeCategory('');
    CAMSBrokerageFormatSummary.GetMemoStatus();
