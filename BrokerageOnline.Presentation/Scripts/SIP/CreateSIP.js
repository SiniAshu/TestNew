...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        rowNum: 100,
        ignoreCase: true,
        colNames: ['Select', 'Memo Number', 'MemoId', 'Memo Type', 'Memo Type ID', 'Category', 'ARN No', 'ARN Name', 'From Date', 'To Date', 'Status', 'Raised By', 'Raised On', 'Time', 'Ageing', 'Last Action By', 'Pending With', 'Memo','MemoLevel','isParentId'],
        colModel: [
                 { name: 'select', formatter: CreateSIP.ReturnRadioBox, width: '60px;', search: false },
                 { name: 'MemoNumber', index: 'MemoNumber', align: 'right', formatter: CreateSIP.ReturnSearchHyperLink, sorttype: 'integer', searchoptions: { sopt: ['cn', 'eq', 'ne', 'le', 'lt', 'gt', 'ge'] } },
