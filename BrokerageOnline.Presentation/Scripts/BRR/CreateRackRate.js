...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        ignoreCase: true,
        rowNum: 100,
        colNames: ['Select', 'Memo Number', 'MemoId', 'Memo Type', 'Memo Type ID', 'Transaction Type ', 'Category', 'ARN No', 'ARN Name', 'From Date', 'To Date', 'Status', 'Raised By', 'Raised On', 'Time', 'Ageing', 'Last Action By', 'Pending With', 'MemoLevel', 'isParentId'],
        colModel: [
