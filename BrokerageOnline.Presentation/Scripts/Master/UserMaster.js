var UserMaster = {
    ...
    ClearEditScreen: function () {
        ...
        $('#txt_mobile').val("");
        $('#dd_status').val("");
        $('#chk_IsAllowChat').prop('checked', false);
    },
...
$(function () {
    $("#grid_users").jqGrid({
        ...
        colModel: [
                    ...
                    { name: 'UserId', index: 'UserId', align: 'center', sortable: false, sorttype: 'integer', searchoptions: { sopt: ['eq', 'ne', 'le', 'lt', 'gt', 'ge'] } },
                    { name: 'FullName', index: 'FullName', sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                    { name: 'Designation', index: 'Designation', width: 200, sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                    { name: 'ReportingManagerName', index: 'ReportingManagerName', width: 210, sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                    { name: 'Email', index: 'Email', width: 250, sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                    { name: 'LoginId', index: 'LoginId', width: 100, sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                    ...
                    { name: 'EmpCode', index: 'EmpCode', width: 100, sortable: false, sorttype: 'integer', searchoptions: { sopt: ['eq', 'ne', 'le', 'lt', 'gt', 'ge'] } },
                    //{ name: 'EmployeeCode', index: 'EmployeeCode' },
                    { name: 'EmployeeId', index: 'EmployeeId', width: 100, sortable: false, sorttype: 'integer', searchoptions: { sopt: ['eq', 'ne', 'le', 'lt', 'gt', 'ge'] } },
                    { name: 'RoleName', index: 'RoleName', width: 100, sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                    { name: 'RoleDescription', index: 'RoleDescription', sortable: false, sorttype: 'string', searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
    ...
    jQuery("#grid_users").jqGrid('filterToolbar', { searchOperators: true, stringResult: true, searchOnEnter: false, defaultSearch: "cn", multipleSearch: true });
