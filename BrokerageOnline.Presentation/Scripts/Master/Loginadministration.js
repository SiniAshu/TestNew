var LoginAdministration = {
    ...
    Logoutforce: function (EmployeeLogID) {
       // Utility.writeNotification("warning", "You are forced to logout,Please Contact admin", "", true);
    ...
    RefreshUserLogs: function () {
        ...
        $("#txt_username").val('');
        //LoginAdministration.CommonSearchUserLogs(sessionStorage.UserName);
...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        colModel: [
                ...
                { name: 'act', index: 'act', align: 'center', formatter: LoginAdministration.ReturnLogOutHyperLink, sortable: false,search: false },
