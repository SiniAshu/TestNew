...
$(function () {
    ...
    jQuery("#grid_search_result").jqGrid({
        ...
        colModel: [
                ...
                { name: 'MemoNumber', width: 150, index: 'MemoNumber', align: 'center', formatter: SmartScreenSearch.ReturnSSDetailHyperLink, sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'ARNNo', width: 90, index: 'ARNNo', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'ARNName', width: 250, index: 'ARNName', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'DistributorCategoryName', width: 190, index: 'DistributorCategoryName', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'SchemeCategoryName', width: 150, index: 'SchemeCategoryName', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'SchemeName', width: 250, index: 'SchemeName', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'ChannelName', width: 100, index: 'ChannelName', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'DateFrom', width: 120, index: 'DateFrom', align: 'center', sortable: true, sorttype: 'date', datefmt: 'd/m/Y', formatoptions: { srcformat: 'd/m/Y', newformat: 'd/m/Y' }, searchoptions: { sopt: ['cn', 'eq', 'ne', 'lt', 'gt'] } },
                { name: 'DateTo', width: 110, index: 'DateTo', align: 'center', sortable: true, sorttype: 'date', datefmt: 'd/m/Y', formatoptions: { srcformat: 'd/m/Y', newformat: 'd/m/Y' }, searchoptions: { sopt: ['cn', 'eq', 'ne', 'lt', 'gt'] } },
                { name: 'ZoneName', index: 'ZoneName', width: 100, sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'SubRegionName', index: 'SubRegionName', width: 100, sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'MemoTypeName', index: 'MemoTypeName', width: 210, sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'MemoStatusName', index: 'MemoStatusName', width: 100, sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
                { name: 'RaisedByName', index: 'RaisedByName', sortable: false, searchoptions: { sopt: ['cn', 'nc', 'eq', 'bw', 'ew', 'bn', 'en'] } },
    ...
    jQuery("#grid_search_result").jqGrid('navGrid', '#pager', { add: false, edit: false, del: false, search: true, refresh: true },
