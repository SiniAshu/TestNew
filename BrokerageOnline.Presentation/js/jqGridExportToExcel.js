var ExportToExcel = { 
    ExportJQGridDataToExcel : function(tableCtrl, excelFilename) {
    ...
    excelData = ExportToExcel.removeLastChar(excelData) + "\r\n";
    ...
    //ExportToExcel.postAndRedirect("/Handlers/ExportGridToExcel.ashx?filename=" + excelFilename, { excelData: excelData });

    ExportToExcel.postAndRedirect(Utility.GetHostURL() + "/Handlers/ExportGridToExcel.ashx?filename=" + excelFilename, { excelData: excelData });
},
